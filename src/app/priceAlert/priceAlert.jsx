...
//     return (
//         <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '48px 16px', fontFamily: 'Arial, sans-serif ', backgroundColor:'white' }}>
//             {/* Animated Heading */}
//             <motion.h1
//                 className="text-center text-3xl font-bold tracking-tight text-amber-500 sm:text-4xl mb-9"
...
export default function PriceAlert() {
    ...
    return (
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '48px 16px', fontFamily: 'Arial, sans-serif', backgroundColor: 'white' }}>
            ...
            {/* Graph Section */}
            <motion.div
                style={{ backgroundColor:'amber-500', color: 'text-white', borderRadius: '8px', overflow: 'hidden', border: '1px solid #F59E0B' }}
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 2, delay: 0.5 }}
                viewport={{ once: true }}
            >
                <div style={{ padding: '20px' }}>
                    <svg width="100%" height="400" viewBox="0 0 1000 400" preserveAspectRatio="none">
                        ...
                        {hoveredPoint && (
                            <g transform={`translate(${hoveredPoint.x + 50}, ${getY(hoveredPoint.price) - 20})`}>
                                <rect x="-40" y="-25" width="80" height="50" fill="black" stroke="#F59E0B" />
                                <text x="0" y="-5" fill="white" fontSize="12" textAnchor="middle">
                                    Year: {hoveredPoint.year}
                                </text>
                                <text x="0" y="15" fill="white" fontSize="12" textAnchor="middle">
